...
const GameScreen = () => {
  ...
  const {randomNumber, setRandomNumber, timer, setTimer, shot, setShot, setGameResult, setTotalPoint} = context;
  ...
  /*useEffect(() => { },[]) bu bos useEffect navigation sistemiyle koordineli calismadigi icin navigation in useFocusEffect methodunu kullandik*/
